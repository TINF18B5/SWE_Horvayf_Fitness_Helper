...
public class MusclePlanFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_muscle_plan, container, false);
        RecyclerView recyclerView = view.findViewById(R.id.recycler_view_muscle_plan);
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(new LinearLayoutManager(getContext()));
        MusclePlanAdapter musclePlanAdapter = new MusclePlanAdapter(getContext());
        DataBaseConnector.getInstance().getAllMusclePlans().observe(requireActivity(), musclePlanAdapter::setMusclePlans);
        recyclerView.setAdapter(musclePlanAdapter);
        addFabSpeedDial(view);
        return view;
    }

    private void addFabSpeedDial(View view) {
        FabSpeedDial fabSpeedDial = (FabSpeedDial) view.findViewById(R.id.button_speed_dial_muscle_plan);
    ...
    private void openDeletePopUpWindow(View view) {
        ...
        confirmbtn.setOnClickListener(v1 -> {
            ...
            DataBaseConnector.getInstance().delete(new MusclePlan(id_to_be_deleted_plan, "", "", new Date()));
